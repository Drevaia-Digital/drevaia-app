    ...
    <>
      <Helmet>
        ...
        <link
          rel="alternate"
          hrefLang="es"
          href="https://drevaia.com/es"
        />

        <link
          rel="alternate"
          hrefLang="en"
          href="https://drevaia.com/en"
        />

        <link
          rel="alternate"
          hrefLang="fr"
          href="https://drevaia.com/fr"
        />

        <link
          rel="alternate"
          hrefLang="pt"
          href="https://drevaia.com/pt"
        />
        ...
        <meta
          property="og:url"
          content={`https://drevaia.com/${language}`}
        />

        <meta
          property="og:image"
          content="https://drevaia.com/logo.png"
        />
