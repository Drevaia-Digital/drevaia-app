...
interface BookPreviewModalProps {
  ...
  book: {
    ...
    title: string;
    description: string;
    link: string; // 👈 ESTE ES EL CORRECTO
    collection: string;
    cover?: string;
  } | null;
      ...
      {isOpen && book && (
        <>
          ...
          <motion.div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              className="w-full max-w-2xl max-h-[90vh] overflow-hidden bg-white rounded-3xl shadow-2xl flex flex-col"
